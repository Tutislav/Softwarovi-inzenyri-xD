...
<?php
	...
	$sql = "SELECT id_ukolu, titulek, datum_zadani, termin_splneni, prispevek.id_prispevku FROM ukol JOIN prispevek ON prispevek.id_prispevku = ukol.id_prispevku JOIN uzivatel ON ukol.id_uzivatele = uzivatel.id_uzivatele WHERE uzivatel.email = '" . $_SESSION["email"] . "' AND ukol.splneno = 0";
